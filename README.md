...
**Urdu Writer** ایک سادہ اور طاقتور اینڈرائڈ ایپ ہے جو صارفین کو آسانی سے اردو دستاویزات بنانے،
ایڈیٹ کرنے اور شیئر کرنے کی سہولت فراہم کرتی ہے۔ یہ ایپ ایک مکمل رچ ٹیکسٹ ایڈیٹر، کسٹم فونٹس کی
سپورٹ، اور PDF میں فائلیں ایکسپورٹ کرنے کی صلاحیت کے ساتھ آتی ہے۔
...
*   **ایکسپورٹ کے اختیارات:**
    *   اپنی دستاویزات کو ایپ میں محفوظ کریں
    *   پروفیشنل شیئرنگ کے لیے `.pdf` فائل بنائیں
    *  آفس فائل .doc فائل کے طور پر شیئر کریں
